...
export const TeamMember: React.FC<TeamMemberProps> = ({ name, role, imageUrl }) => {
  return (
    <div className="flex flex-col items-center w-32 md:w-70">
      ...
      <div className="bg-dark text-white pt-6 md:pt-8 pb-2 md:pb-4 px-2 md:px-4 rounded-lg text-center w-full h-20 md:h-28 flex flex-col justify-center">
